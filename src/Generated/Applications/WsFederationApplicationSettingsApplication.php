...
class WsFederationApplicationSettingsApplication extends \Okta\Applications\ApplicationSettingsApplication
{
    ...
    {
        $this->setProperty(self::REALM, $realm);
        return $this;
    }
    /**
     * Get the siteURL.
    ...
    {
        $this->setProperty(self::SITE_URL, $siteURL);
        return $this;
    }
    /**
     * Get the groupName.
    ...
    {
        $this->setProperty(self::GROUP_NAME, $groupName);
        return $this;
    }
    /**
     * Get the wReplyURL.
    ...
    {
        $this->setProperty(self::W_REPLY_URL, $wReplyURL);
        return $this;
    }
    /**
     * Get the groupFilter.
    ...
    {
        $this->setProperty(self::GROUP_FILTER, $groupFilter);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::NAME_ID_FORMAT, $nameIDFormat);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::W_REPLY_OVERRIDE, $wReplyOverride);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::GROUP_VALUE_FORMAT, $groupValueFormat);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::USERNAME_ATTRIBUTE, $usernameAttribute);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::AUDIENCE_RESTRICTION, $audienceRestriction);
        return $this;
    }
    /**
