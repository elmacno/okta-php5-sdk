...
class ApplicationAccessibility extends \Okta\Resource\AbstractResource
{
    ...
    {
        $this->setProperty(self::SELF_SERVICE, $selfService);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::ERROR_REDIRECT_URL, $errorRedirectUrl);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::LOGIN_REDIRECT_URL, $loginRedirectUrl);
        return $this;
    }
}