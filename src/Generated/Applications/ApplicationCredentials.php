...
class ApplicationCredentials extends \Okta\Resource\AbstractResource
{
    ...
    {
        return $this->getResourceProperty(self::USER_NAME_TEMPLATE, \Okta\Applications\ApplicationCredentialsUsernameTemplate::class, $options);
    }
    /**
    ...
    {
        $this->setResourceProperty(self::USER_NAME_TEMPLATE, $userNameTemplate);
        return $this;
    }
}