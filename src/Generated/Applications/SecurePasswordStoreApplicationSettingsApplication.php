...
class SecurePasswordStoreApplicationSettingsApplication extends \Okta\Applications\ApplicationSettingsApplication
{
    ...
    {
        $this->setProperty(self::PASSWORD_FIELD, $passwordField);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::USERNAME_FIELD, $usernameField);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::OPTIONAL_FIELD_1, $optionalField1);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::OPTIONAL_FIELD_2, $optionalField2);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::OPTIONAL_FIELD_3, $optionalField3);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::OPTIONAL_FIELD_1_VALUE, $optionalField1Value);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::OPTIONAL_FIELD_2_VALUE, $optionalField2Value);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::OPTIONAL_FIELD_3_VALUE, $optionalField3Value);
        return $this;
    }
}