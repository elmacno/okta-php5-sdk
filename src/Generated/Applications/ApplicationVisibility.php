...
class ApplicationVisibility extends \Okta\Resource\AbstractResource
{
    ...
    {
        return $this->getResourceProperty(self::HIDE, \Okta\Applications\ApplicationVisibilityHide::class, $options);
    }
    /**
     * Set the hide.
     *
    ...
    {
        $this->setResourceProperty(self::HIDE, $hide);
        return $this;
    }
    /**
     * Get the appLinks.
    ...
    {
        $this->setProperty(self::APP_LINKS, $appLinks);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::AUTO_SUBMIT_TOOLBAR, $autoSubmitToolbar);
        return $this;
    }
}