...
class OpenIdConnectApplication extends \Okta\Applications\Application
{
    ...
    {
        return $this->getResourceProperty(self::SETTINGS, \Okta\Applications\OpenIdConnectApplicationSettings::class, $options);
    }
    /**
     * Set the settings.
     *
    ...
    {
        return $this->getResourceProperty(self::CREDENTIALS, \Okta\Applications\OAuthApplicationCredentials::class, $options);
    }
    /**
     * Set the credentials.
     *
