...
class ApplicationCredentialsOAuthClient extends \Okta\Resource\AbstractResource
{
    ...
    {
        $this->setProperty(self::CLIENT_ID, $client_id);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::CLIENT_SECRET, $client_secret);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::AUTO_KEY_ROTATION, $autoKeyRotation);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::TOKEN_ENDPOINT_AUTH_METHOD, $token_endpoint_auth_method);
        return $this;
    }
}