...
class SchemeApplicationCredentials extends \Okta\Applications\ApplicationCredentials
{
    ...
    {
        $this->setProperty(self::SCHEME, $scheme);
        return $this;
    }
    /**
     * Get the signing.
    ...
    {
        return $this->getResourceProperty(self::SIGNING, \Okta\Applications\ApplicationCredentialsSigning::class, $options);
    }
    /**
     * Set the signing.
     *
    ...
    {
        $this->setResourceProperty(self::SIGNING, $signing);
        return $this;
    }
    /**
     * Get the password.
    ...
    {
        $this->setProperty(self::USER_NAME, $userName);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::REVEAL_PASSWORD, $revealPassword);
        return $this;
    }
}