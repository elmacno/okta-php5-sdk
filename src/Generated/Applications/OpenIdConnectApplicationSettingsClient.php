...
class OpenIdConnectApplicationSettingsClient extends \Okta\Resource\AbstractResource
{
    ...
    {
        $this->setProperty(self::TOS_URI, $tos_uri);
        return $this;
    }
    /**
     * Get the logo_uri.
    ...
    {
        $this->setProperty(self::LOGO_URI, $logo_uri);
        return $this;
    }
    /**
     * Get the client_uri.
    ...
    {
        $this->setProperty(self::CLIENT_URI, $client_uri);
        return $this;
    }
    /**
     * Get the policy_uri.
    ...
    {
        $this->setProperty(self::POLICY_URI, $policy_uri);
        return $this;
    }
    /**
     * Get the grant_types.
    ...
    {
        $this->setProperty(self::GRANT_TYPES, $grant_types);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::CONSENT_METHOD, $consent_method);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::RESPONSE_TYPES, $response_types);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::APPLICATION_TYPE, $application_type);
        return $this;
    }
}