...
class Application extends \Okta\Resource\AbstractResource
{
    ...
    {
        $application = \Okta\Client::getInstance()->getDataStore()->getResource($query, \Okta\Applications\Application::class, "/apps");
        return $application->convertFromGenericApplication();
    }
    public function save()
    {
        return \Okta\Client::getInstance()->getDataStore()->saveResource("/apps", $this, \Okta\Applications\Application::class);
    }
    public function delete()
    {
        return \Okta\Client::getInstance()->getDataStore()->deleteResource("/apps", $this);
    }
    /**
     * Get the id.
     *
    ...
    {
        $this->setProperty(self::LABEL, $label);
        return $this;
    }
    /**
     * Get the _links.
    ...
    {
        $this->setProperty(self::FEATURES, $features);
        return $this;
    }
    /**
     * Get the settings.
    ...
    {
        return $this->getResourceProperty(self::SETTINGS, \Okta\Applications\ApplicationSettings::class, $options);
    }
    /**
     * Set the settings.
     *
    ...
    {
        return $this->getResourceProperty(self::LICENSING, \Okta\Applications\ApplicationLicensing::class, $options);
    }
    /**
     * Set the licensing.
     *
    ...
    {
        $this->setResourceProperty(self::LICENSING, $licensing);
        return $this;
    }
    /**
     * Get the signOnMode.
    ...
    {
        $this->setProperty(self::SIGN_ON_MODE, $signOnMode);
        return $this;
    }
    /**
     * Get the visibility.
    ...
    {
        return $this->getResourceProperty(self::VISIBILITY, \Okta\Applications\ApplicationVisibility::class, $options);
    }
    /**
     * Set the visibility.
     *
    ...
    {
        $this->setResourceProperty(self::VISIBILITY, $visibility);
        return $this;
    }
    /**
     * Get the credentials.
    ...
    {
        return $this->getResourceProperty(self::CREDENTIALS, \Okta\Applications\ApplicationCredentials::class, $options);
    }
    /**
     * Set the credentials.
     *
    ...
    {
        return $this->getResourceProperty(self::ACCESSIBILITY, \Okta\Applications\ApplicationAccessibility::class, $options);
    }
    /**
    ...
    {
        $this->setResourceProperty(self::ACCESSIBILITY, $accessibility);
        return $this;
    }
    /**
     ...
     */
    public function getApplicationUsers(array $options = [])
    {
        return $this->getDataStore()->getCollection("/api/v1/apps/{$this->getId()}/users", \Okta\Applications\AppUser::class, \Okta\Applications\Collection::class, $options);
    }
    /**
    ...
    public function assignUserToApplication(AppUser $appUser)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('POST', $uri, $appUser);
    ...
    public function createApplicationGroupAssignment($groupId, ApplicationGroupAssignment $applicationGroupAssignment)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('PUT', $uri, $applicationGroupAssignment);
     ...
     * @return \Okta\Applications\Collection
     */
    public function getGroupAssignments(array $options = [])
    {
        return $this->getDataStore()->getCollection("/api/v1/apps/{$this->getId()}/groups", \Okta\Applications\ApplicationGroupAssignment::class, \Okta\Applications\Collection::class, $options);
    }
    /**
     ...
     * @return \Okta\Applications\Collection
     */
    public function getKeys(array $options = [])
    {
        return $this->getDataStore()->getCollection("/api/v1/apps/{$this->getId()}/credentials/keys", \Okta\Applications\JsonWebKey::class, \Okta\Applications\Collection::class, $options);
    }
}