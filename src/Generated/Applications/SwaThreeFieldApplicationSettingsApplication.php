...
class SwaThreeFieldApplicationSettingsApplication extends \Okta\Applications\ApplicationSettingsApplication
{
    ...
    {
        $this->setProperty(self::TARGET_URL, $targetUrl);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::LOGIN_URL_REGEX, $loginUrlRegex);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::BUTTON_SELECTOR, $buttonSelector);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::EXTRA_FIELD_VALUE, $extraFieldValue);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::PASSWORD_SELECTOR, $passwordSelector);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::USER_NAME_SELECTOR, $userNameSelector);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::EXTRA_FIELD_SELECTOR, $extraFieldSelector);
        return $this;
    }
}