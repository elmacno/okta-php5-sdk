...
class ApplicationSettingsNotificationsVpn extends \Okta\Resource\AbstractResource
{
    ...
    {
        $this->setProperty(self::HELP_URL, $helpUrl);
        return $this;
    }
    /**
     * Get the message.
    ...
    {
        return $this->getResourceProperty(self::NETWORK, \Okta\Applications\ApplicationSettingsNotificationsVpnNetwork::class, $options);
    }
    /**
     * Set the network.
     *
    ...
    {
        $this->setResourceProperty(self::NETWORK, $network);
        return $this;
    }
}