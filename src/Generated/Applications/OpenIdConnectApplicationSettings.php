...
class OpenIdConnectApplicationSettings extends \Okta\Applications\ApplicationSettings
{
     ...
     */
    public function getOauthClient(array $options = [])
    {
        return $this->getResourceProperty(self::OAUTH_CLIENT, \Okta\Applications\OpenIdConnectApplicationSettingsClient::class, $options);
    }
    /**
     * Set the oauthClient.
     *
    ...
    {
        $this->setResourceProperty(self::OAUTH_CLIENT, $oauthClient);
        return $this;
    }
}