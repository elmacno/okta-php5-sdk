...
class AppUser extends \Okta\Resource\AbstractResource
{
    ...
    {
        return \Okta\Client::getInstance()->getDataStore()->saveResource("/apps/{$appId}/users", $this, \Okta\Applications\AppUser::class);
    }
    public function delete($appId)
    {
        return \Okta\Client::getInstance()->getDataStore()->deleteResource("/apps/{$appId}/users", $this);
    }
    /**
     * Get the id.
     *
    ...
    {
        $this->setProperty(self::SCOPE, $scope);
        return $this;
    }
    /**
     * Get the _links.
    ...
    {
        $this->setProperty(self::PROFILE, $profile);
        return $this;
    }
    /**
     * Get the lastSync.
    ...
    {
        return $this->getResourceProperty(self::CREDENTIALS, \Okta\Applications\AppUserCredentials::class, $options);
    }
    /**
     * Set the credentials.
     *
