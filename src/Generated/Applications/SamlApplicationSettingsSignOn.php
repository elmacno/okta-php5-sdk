...
class SamlApplicationSettingsSignOn extends \Okta\Resource\AbstractResource
{
    ...
    {
        $this->setProperty(self::AUDIENCE, $audience);
        return $this;
    }
    /**
     * Get the spIssuer.
    ...
    {
        $this->setProperty(self::SP_ISSUER, $spIssuer);
        return $this;
    }
    /**
     * Get the idpIssuer.
    ...
    {
        $this->setProperty(self::IDP_ISSUER, $idpIssuer);
        return $this;
    }
    /**
     * Get the recipient.
    ...
    {
        $this->setProperty(self::RECIPIENT, $recipient);
        return $this;
    }
    /**
     * Get the ssoAcsUrl.
    ...
    {
        $this->setProperty(self::SSO_ACS_URL, $ssoAcsUrl);
        return $this;
    }
    /**
     * Get the destination.
    ...
    {
        $this->setProperty(self::DESTINATION, $destination);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::RESPONSE_SIGNED, $responseSigned);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::ASSERTION_SIGNED, $assertionSigned);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::DIGEST_ALGORITHM, $digestAlgorithm);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::HONOR_FORCE_AUTHN, $honorForceAuthn);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::AUDIENCE_OVERRIDE, $audienceOverride);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::DEFAULT_RELAY_STATE, $defaultRelayState);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::RECIPIENT_OVERRIDE, $recipientOverride);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::REQUEST_COMPRESSED, $requestCompressed);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::SSO_ACS_URL_OVERRIDE, $ssoAcsUrlOverride);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::SIGNATURE_ALGORITHM, $signatureAlgorithm);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::ATTRIBUTE_STATEMENTS, $attributeStatements);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::DESTINATION_OVERRIDE, $destinationOverride);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::SUBJECT_NAME_ID_FORMAT, $subjectNameIdFormat);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::AUTHN_CONTEXT_CLASS_REF, $authnContextClassRef);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::SUBJECT_NAME_ID_TEMPLATE, $subjectNameIdTemplate);
        return $this;
    }
}