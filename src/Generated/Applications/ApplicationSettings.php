...
class ApplicationSettings extends \Okta\Resource\AbstractResource
{
    ...
    {
        return $this->getResourceProperty(self::APP, \Okta\Applications\ApplicationSettingsApplication::class, $options);
    }
    /**
     * Set the app.
     *
    ...
    {
        $this->setResourceProperty(self::APP, $app);
        return $this;
    }
    /**
    ...
    {
        return $this->getResourceProperty(self::NOTIFICATIONS, \Okta\Applications\ApplicationSettingsNotifications::class, $options);
    }
    /**
    ...
    {
        $this->setResourceProperty(self::NOTIFICATIONS, $notifications);
        return $this;
    }
}