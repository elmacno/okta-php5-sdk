...
class LogEvent extends \Okta\Resource\AbstractResource
{
     ...
     */
    public function getActor(array $options = [])
    {
        return $this->getResourceProperty(self::ACTOR, \Okta\Logs\LogActor::class, $options);
    }
    /**
     * Get the client.
     *
    ...
    {
        return $this->getResourceProperty(self::CLIENT, \Okta\Logs\LogClient::class, $options);
    }
    /**
     * Get the target.
     *
     ...
     */
    public function getOutcome(array $options = [])
    {
        return $this->getResourceProperty(self::OUTCOME, \Okta\Logs\LogOutcome::class, $options);
    }
    /**
     * Get the request.
     *
    ...
    {
        return $this->getResourceProperty(self::REQUEST, \Okta\Logs\LogRequest::class, $options);
    }
    /**
     * Get the version.
     *
    ...
    {
        return $this->getResourceProperty(self::TRANSACTION, \Okta\Logs\LogTransaction::class, $options);
    }
    /**
     ...
     */
    public function getDebugContext(array $options = [])
    {
        return $this->getResourceProperty(self::DEBUG_CONTEXT, \Okta\Logs\LogDebugContext::class, $options);
    }
    /**
     ...
     */
    public function getSecurityContext(array $options = [])
    {
        return $this->getResourceProperty(self::SECURITY_CONTEXT, \Okta\Logs\LogSecurityContext::class, $options);
    }
    /**
     ...
     */
    public function getAuthenticationContext(array $options = [])
    {
        return $this->getResourceProperty(self::AUTHENTICATION_CONTEXT, \Okta\Logs\LogAuthenticationContext::class, $options);
    }
}