...
class LogClient extends \Okta\Resource\AbstractResource
{
     ...
     */
    public function getUserAgent(array $options = [])
    {
        return $this->getResourceProperty(self::USER_AGENT, \Okta\Logs\LogUserAgent::class, $options);
    }
    /**
     ...
     */
    public function getGeographicalContext(array $options = [])
    {
        return $this->getResourceProperty(self::GEOGRAPHICAL_CONTEXT, \Okta\Logs\LogGeographicalContext::class, $options);
    }
}