...
class Session extends \Okta\Resource\AbstractResource
{
    ...
    {
        return \Okta\Client::getInstance()->getDataStore()->getResource($query, \Okta\Sessions\Session::class, "/sessions");
    }
    public function delete()
    {
        return \Okta\Client::getInstance()->getDataStore()->deleteResource("/sessions", $this);
    }
    /**
     * Get the id.
     *
     ...
     */
    public function getIdp(array $options = [])
    {
        return $this->getResourceProperty(self::IDP, \Okta\Sessions\SessionIdentityProvider::class, $options);
    }
    /**
     * Get the login.
     *
