...
class Factor extends \Okta\Resource\AbstractResource
{
    ...
    {
        $this->setProperty(self::DEVICE, $device);
        return $this;
    }
    /**
     * Get the status.
    ...
    {
        $this->setProperty(self::USER_ID, $userId);
        return $this;
    }
    /**
     * Get the verify.
     ...
     */
    public function getVerify(array $options = [])
    {
        return $this->getResourceProperty(self::VERIFY, \Okta\UserFactors\VerifyFactorRequest::class, $options);
    }
    /**
     * Set the verify.
     *
    ...
    {
        $this->setResourceProperty(self::VERIFY, $verify);
        return $this;
    }
    /**
     * Get the profile.
    ...
    {
        return $this->getResourceProperty(self::PROFILE, \Okta\UserFactors\FactorProfile::class, $options);
    }
    /**
     * Set the profile.
     *
    ...
    {
        $this->setProperty(self::SESSION_ID, $sessionId);
        return $this;
    }
    /**
     * Get the deviceType.
    ...
    {
        $this->setProperty(self::FACTOR_TYPE, $factorType);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::MFA_STATE_TOKEN_ID, $mfaStateTokenId);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::RECHALLENGE_EXISTING_FACTOR, $rechallengeExistingFactor);
        return $this;
    }
    /**
    ...
    public function activate(VerifyFactorRequest $verifyFactorRequest)
    {
        ...
        $body = $this->getDataStore()->executeRequest('POST', $uri, $verifyFactorRequest);
