...
class VerifyFactorRequest extends \Okta\Resource\AbstractResource
{
    ...
    {
        $this->setProperty(self::ANSWER, $answer);
        return $this;
    }
    /**
     * Get the passCode.
    ...
    {
        $this->setProperty(self::PASS_CODE, $passCode);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::NEXT_PASS_CODE, $nextPassCode);
        return $this;
    }
    /**
    ...
    {
        $this->setProperty(self::ACTIVATION_TOKEN, $activationToken);
        return $this;
    }
}