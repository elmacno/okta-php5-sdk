...
class GroupRule extends \Okta\Resource\AbstractResource
{
    ...
    {
        return \Okta\Client::getInstance()->getDataStore()->saveResource("/groups", $this, \Okta\GroupRules\GroupRule::class);
    }
    public function delete()
    {
        return \Okta\Client::getInstance()->getDataStore()->deleteResource("/groups", $this);
    }
    /**
     * Get the id.
     *
    ...
    {
        return $this->getResourceProperty(self::ACTIONS, \Okta\GroupRules\GroupRuleAction::class, $options);
    }
    /**
     * Set the actions.
     *
    ...
    {
        $this->setResourceProperty(self::ACTIONS, $actions);
        return $this;
    }
    /**
     * Get the created.
    ...
    {
        return $this->getResourceProperty(self::CONDITIONS, \Okta\GroupRules\GroupRuleConditions::class, $options);
    }
    /**
     * Set the conditions.
     *
    ...
    {
        $this->setResourceProperty(self::CONDITIONS, $conditions);
        return $this;
    }
    /**
     * Get the lastUpdated.
