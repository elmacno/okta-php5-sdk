...
class GroupRulePeopleCondition extends \Okta\Resource\AbstractResource
{
    ...
    {
        return $this->getResourceProperty(self::USERS, \Okta\GroupRules\GroupRuleUserCondition::class, $options);
    }
    /**
     * Set the users.
     *
    ...
    {
        $this->setResourceProperty(self::USERS, $users);
        return $this;
    }
    /**
     * Get the groups.
    ...
    {
        return $this->getResourceProperty(self::GROUPS, \Okta\GroupRules\GroupRuleGroupCondition::class, $options);
    }
    /**
     * Set the groups.
     *
    ...
    {
        $this->setResourceProperty(self::GROUPS, $groups);
        return $this;
    }
}