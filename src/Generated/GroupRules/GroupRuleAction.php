...
class GroupRuleAction extends \Okta\Resource\AbstractResource
{
    ...
    {
        return $this->getResourceProperty(self::ASSIGN_USER_TO_GROUPS, \Okta\GroupRules\GroupRuleGroupAssignment::class, $options);
    }
    /**
    ...
    {
        $this->setResourceProperty(self::ASSIGN_USER_TO_GROUPS, $assignUserToGroups);
        return $this;
    }
}