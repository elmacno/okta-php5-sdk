...
class GroupRuleConditions extends \Okta\Resource\AbstractResource
{
    ...
    {
        return $this->getResourceProperty(self::PEOPLE, \Okta\GroupRules\GroupRulePeopleCondition::class, $options);
    }
    /**
     * Set the people.
     *
    ...
    {
        $this->setResourceProperty(self::PEOPLE, $people);
        return $this;
    }
    /**
     * Get the expression.
    ...
    {
        return $this->getResourceProperty(self::EXPRESSION, \Okta\GroupRules\GroupRuleExpression::class, $options);
    }
    /**
     * Set the expression.
     *
    ...
    {
        $this->setResourceProperty(self::EXPRESSION, $expression);
        return $this;
    }
}