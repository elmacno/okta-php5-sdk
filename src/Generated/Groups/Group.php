...
class Group extends \Okta\Resource\AbstractResource
{
    ...
    {
        return \Okta\Client::getInstance()->getDataStore()->saveResource("/groups", $this, \Okta\Groups\Group::class);
    }
    ...
    {
        return $this->getResourceProperty(self::PROFILE, \Okta\Groups\GroupProfile::class, $options);
    }
    /**
     * Set the profile.
     *
    ...
    {
        return $this->getDataStore()->getCollection("/api/v1/groups/{$this->getId()}/users", \Okta\Users\User::class, \Okta\Users\Collection::class, $options);
    }
}