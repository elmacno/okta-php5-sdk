...
class ChangePasswordRequest extends \Okta\Resource\AbstractResource
{
    ...
    {
        return $this->getResourceProperty(self::NEW_PASSWORD, \Okta\Users\PasswordCredential::class, $options);
    }
    /**
     * Set the newPassword.
     *
    ...
    {
        return $this->getResourceProperty(self::OLD_PASSWORD, \Okta\Users\PasswordCredential::class, $options);
    }
    /**
     * Set the oldPassword.
     *
