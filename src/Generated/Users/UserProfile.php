...
class UserProfile extends \Okta\Resource\AbstractResource
{
    ...
    {
        $this->setProperty(self::LAST_NAME, $lastName);
        return $this;
    }
    /**
     * Get the firstName.
    ...
    {
        $this->setProperty(self::FIRST_NAME, $firstName);
        return $this;
    }
    /**
     * Get the mobilePhone.
    ...
    {
        $this->setProperty(self::MOBILE_PHONE, $mobilePhone);
        return $this;
    }
    /**
     * Get the secondEmail.
    ...
    {
        $this->setProperty(self::SECOND_EMAIL, $secondEmail);
        return $this;
    }
}