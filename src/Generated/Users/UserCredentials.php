...
class UserCredentials extends \Okta\Resource\AbstractResource
{
    ...
    {
        return $this->getResourceProperty(self::PASSWORD, \Okta\Users\PasswordCredential::class, $options);
    }
    /**
     * Set the password.
     *
    ...
    {
        $this->setResourceProperty(self::PASSWORD, $password);
        return $this;
    }
    /**
     * Get the provider.
    ...
    {
        return $this->getResourceProperty(self::PROVIDER, \Okta\Users\AuthenticationProvider::class, $options);
    }
    /**
     * Set the provider.
     *
    ...
    {
        $this->setResourceProperty(self::PROVIDER, $provider);
        return $this;
    }
    /**
    ...
    {
        return $this->getResourceProperty(self::RECOVERY_QUESTION, \Okta\Users\RecoveryQuestionCredential::class, $options);
    }
    /**
    ...
    {
        $this->setResourceProperty(self::RECOVERY_QUESTION, $recovery_question);
        return $this;
    }
}