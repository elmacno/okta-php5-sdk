...
class User extends \Okta\Resource\AbstractResource
{
    ...
    {
        return \Okta\Client::getInstance()->getDataStore()->createResource("/users", $this, \Okta\Users\User::class, $query);
    }
    public function get($query)
    {
        return \Okta\Client::getInstance()->getDataStore()->getResource($query, \Okta\Users\User::class, "/users");
    }
    public function save()
    {
        return \Okta\Client::getInstance()->getDataStore()->saveResource("/users", $this, \Okta\Users\User::class);
    }
    public function delete()
    {
        return \Okta\Client::getInstance()->getDataStore()->deleteResource("/users", $this);
    }
    /**
     * Get the id.
     *
    ...
    {
        return $this->getResourceProperty(self::PROFILE, \Okta\Users\UserProfile::class, $options);
    }
    /**
     * Set the profile.
     *
    ...
    {
        $this->setResourceProperty(self::PROFILE, $profile);
        return $this;
    }
    /**
     * Get the _embedded.
    ...
    {
        return $this->getResourceProperty(self::CREDENTIALS, \Okta\Users\UserCredentials::class, $options);
    }
    /**
     * Set the credentials.
     *
    ...
    public function endAllSessions($oauthTokens = false)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('DELETE', $uri, '', ['query' => ['oauthTokens' => $oauthTokens]]);
        return $body;
    }
    /**
     ...
     */
    public function getAppLinks(array $options = [])
    {
        return $this->getDataStore()->getCollection("/api/v1/users/{$this->getId()}/appLinks", \Okta\Users\AppLink::class, \Okta\Users\Collection::class, $options);
    }
    /**
    ...
    public function changePassword(ChangePasswordRequest $changePasswordRequest)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('POST', $uri, $changePasswordRequest);
    ...
    public function changeRecoveryQuestion(UserCredentials $userCredentials)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('POST', $uri, $userCredentials);
        return new \Okta\Users\UserCredentials(null, $body);
    }
    /**
    ...
    public function forgotPassword(UserCredentials $userCredentials, $sendEmail = true)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('POST', $uri, $userCredentials, ['query' => ['sendEmail' => $sendEmail]]);
    ...
    {
        return $this->getDataStore()->getCollection("/api/v1/users/{$this->getId()}/roles", \Okta\Users\Role::class, \Okta\Users\Collection::class, $options);
    }
    /**
    ...
    public function addRole(Role $role)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('POST', $uri, $role);
    ...
    public function removeRole($roleId)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('DELETE', $uri);
        return $body;
    }
    /**
     ...
     */
    public function getGroupTargetsForRole($roleId, array $options = [])
    {
        return $this->getDataStore()->getCollection("/api/v1/users/{$this->getId()}/roles/{$roleId}/targets/groups", \Okta\Groups\Group::class, \Okta\Groups\Collection::class, $options);
    }
    /**
     * 
     *
    ...
    public function addGroupTargetToRole($roleId, $groupId)
    {
        $uri = "/api/v1/users/{$this->getId()}/roles/{$roleId}/targets/groups/{$groupId}";
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('PUT', $uri);
        return $body;
    }
    /**
     * Get the Group object.
    ...
    {
        return $this->getDataStore()->getCollection("/api/v1/users/{$this->getId()}/groups", \Okta\Groups\Group::class, \Okta\Groups\Collection::class, $options);
    }
    /**
    ...
    public function activate($sendEmail = true)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('POST', $uri, '', ['query' => ['sendEmail' => $sendEmail]]);
    ...
    public function deactivate()
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('POST', $uri);
        return $body;
    }
    /**
    ...
    public function expirePassword($tempPassword = false)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('POST', $uri, '', ['query' => ['tempPassword' => $tempPassword]]);
    ...
    public function addFactor(Factor $factor, $updatePhone = false)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('POST', $uri, $factor, ['query' => ['updatePhone' => $updatePhone]]);
     ...
     */
    public function getSupportedFactors(array $options = [])
    {
        return $this->getDataStore()->getCollection("/api/v1/users/{$this->getId()}/factors/catalog", \Okta\UserFactors\Factor::class, \Okta\UserFactors\Collection::class, $options);
    }
    /**
     * Get the Factor object.
     *
    ...
    {
        return $this->getDataStore()->getCollection("/api/v1/users/{$this->getId()}/factors", \Okta\UserFactors\Factor::class, \Okta\UserFactors\Collection::class, $options);
    }
    /**
     ...
     */
    public function getSupportedSecurityQuestions(array $options = [])
    {
        return $this->getDataStore()->getCollection("/api/v1/users/{$this->getId()}/factors/questions", \Okta\UserFactors\SecurityQuestion::class, \Okta\UserFactors\SecurityQuestionsCollection::class, $options);
    }
    /**
    ...
    public function getFactor($factorId)
    {
        ...
        $uri = $this->getDataStore()->buildUri($this->getDataStore()->getOrganizationUrl() . $uri);
        $body = $this->getDataStore()->executeRequest('GET', $uri);
        $response = new \Okta\UserFactors\Factor(null, $body);
        return $response->convertFromGenericFactor();
    }
}