...
class DefaultDataStore
{
     ...
     */
    public function __construct($token, $organizationUrl, HttpClient $httpClient = null)
    {
        $this->token = $token;
        $this->organizationUrl = $organizationUrl;
        $authenticationPlugin = new AuthenticationPlugin(new SswsAuth($this->token));
        $this->httpClient = new PluginClient($httpClient ?: HttpClientDiscovery::find(), [$authenticationPlugin]);
     ...
     * @return object
     */
    public function instantiate($class, \stdClass $properties = null, array $options = [])
    {
