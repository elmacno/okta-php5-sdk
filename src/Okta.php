...
class Okta
{
    ...
    {
        return $this->dataStore->getCollection('/api/v1/groups', Group::class, GroupCollection::class, $options);
    }
    public function getLogs(array $options = [])
    {
        return $this->dataStore->getCollection('/api/v1/logs', LogEvent::class, LogCollection::class, $options);
    }
}