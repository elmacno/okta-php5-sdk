...
class Client
{
     ...
     */
    public function __construct($token, $organizationUrl, HttpClient $httpClient = null, $integrationUserAgent = null, CacheManager $cacheManager = null)
    {
        $this->token = $token;
        ...
        $this->dataStore = new DefaultDataStore($this->token, $this->organizationUrl, $this->httpClient);
     ...
     * @return string
     */
    public function getIntegrationUserAgent()
    {
    ...
    public static function getInstance()
    {
        if (null === self::$instance) {
            throw new \RuntimeException('The client has not be instantiated yet, please
